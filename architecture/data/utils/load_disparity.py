...
def load_eth3d_disp(img_path):
    """load scene flow disparity image
    Args:
        img_path:
    Returns:
    """
    assert img_path.endswith('.pfm'), "eth3d disparity image must end with .pfm" \
                                      "but got {}".format(img_path)
...
def load_middlebury_disp(img_path):
    """load scene flow disparity image
    Args:
        img_path:
    Returns:
    """
    assert img_path.endswith('.pfm'), "middlebury disparity image must end with .pfm" \
                                      "but got {}".format(img_path)
